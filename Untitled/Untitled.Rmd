...
**Please note:** Per [their guidelines](https://publications.copernicus.org/for_authors/manuscript_preparation.html), Copernicus does not support additional \LaTeX{} packages or new \LaTeX{} commands than those defined in their `.cls` file. This means that you cannot add any extra dependencies and a warning will be thrown if so.\
